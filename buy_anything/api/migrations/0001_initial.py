# Generated by Django 5.0 on 2024-11-10 07:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount', models.DecimalField(decimal_places=2, default=Decimal('0'), max_digits=3, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.product')),
                ('variation_class', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='api.variationclass')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('transaction_details', models.JSONField(default=dict, encoder=django.core.serializers.json.DjangoJSONEncoder)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('payment_method', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='api.paymentmethod')),
                ('payment_status', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='api.paymentstatus')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='api.paymentdetail')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='api.subcategory')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='variation_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='api.variationtype'),
        ),
        migrations.AddField(
